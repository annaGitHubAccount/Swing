...
public class MainFrame extends JFrame {
	 ...
	 * wyswietlane
	 * 
	 * Dzieki temu, ze backend i frontend sa od siebie oddzielone, mozna dobrze przetestowac backend --> klasa TestDatabase.
	 * 
	 * klasa Database, metoda save():
	 * 1. Najpierw sprawdzam czy dana osoba znajduje sie w bazie danych
	 * 2. Jesli tak, to robie update
	 * 3. Jesli nie, to robie insert
	 * 
	 * a potem testuje metody w TestDatabase.
	 * 
	 * 
	 * Model- to jest siec obiektow np. PersonTableModel
	 * 
	 */
