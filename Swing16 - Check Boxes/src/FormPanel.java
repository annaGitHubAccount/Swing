...
public class FormPanel extends JPanel {
	...
	// jak klikne w check box np. US citizen, trzeba bedzie wprowadzic tax ID
	...
	public FormPanel() {
		...
		okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				...
				FormEvent formEvent = new FormEvent(this, name, occupation, ageCategory.getId(), employmentCategory, taxID, usCitizen);
